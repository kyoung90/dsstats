...
{
    public partial class WinrateNgComponent : StatsComponent, IDisposable
    {
        [Inject]
        public IWinrateNgService winrateService { get; set; } = default!;

        readonly SemaphoreSlim ss = new(1, 1);
        ...
        public override async Task LoadData(bool init = false)
        {
            ...
            try
            {
                ...
                WinrateNgRequest request = Request as WinrateNgRequest  ?? new();
                request.RatingNgType = (RatingNgType)(int)Request.RatingType;
