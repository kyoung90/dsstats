...
public class ReplayContext : DbContext
{
    ...
    public virtual DbSet<PlayerNgRatingChange> PlayerNgRatingChanges { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ArcadeReplay>(entity =>
        {
            ...
            entity.HasOne(o => o.Replay)
            .WithMany(m => m.ArcadeReplays)
            .HasForeignKey(f => f.ReplayId)
