...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dsstats.db8.Aram.AramEvent", b =>
                {
                    b.Property<int>("AramEventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("AramEventId"));
                    ...
                    b.ToTable("AramEvents");
                });

            modelBuilder.Entity("dsstats.db8.Aram.AramMatch", b =>
                {
                    b.Property<int>("AramMatchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("AramMatchId"));
                    ...
                    b.Property<int?>("Replay2Id")
                        .HasColumnType("int");

                    b.Property<int>("Team1Rating")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Replay2Id");

                    b.ToTable("AramMatches");
                });
            ...
            modelBuilder.Entity("dsstats.db8.Aram.AramPlayer", b =>
                {
                    ...
                    b.ToTable("AramPlayers");
                });

            modelBuilder.Entity("dsstats.db8.Aram.AramSlot", b =>
                {
                    b.Property<int>("AramSlotId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("AramSlotId"));
            ...
            modelBuilder.Entity("dsstats.db8.Aram.AramMatch", b =>
                {
                    ...
                    b.HasOne("dsstats.db8.Replay", "Replay2")
                        .WithMany()
                        .HasForeignKey("Replay2Id");

                    b.Navigation("AramEvent");

                    b.Navigation("Replay1");

                    b.Navigation("Replay2");
                });
            ...
            modelBuilder.Entity("dsstats.db8.Aram.AramSlot", b =>
                {
                    b.HasOne("dsstats.db8.Aram.AramMatch", "AramMatch")
                        .WithMany("AramSlots")
                        .HasForeignKey("AramMatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("AramMatch");

                    b.Navigation("AramPlayer");
                });
