...
namespace MysqlMigrations.Migrations
{
    ...
    [Migration("20240315192853_PlayerNgRatingDefaultValues")]
    partial class PlayerNgRatingDefaultValues
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dsstats.db8.Ratings.PlayerNgRatingChange", b =>
                {
                    b.Property<int>("PlayerNgRatingChangeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("PlayerNgRatingChangeId"));
                    ...
                    b.HasKey("PlayerNgRatingChangeId");

                    b.HasIndex("PlayerNgRatingId");

                    b.ToTable("PlayerNgRatingChanges");
                });
            ...
            modelBuilder.Entity("dsstats.db8.Ratings.PlayerNgRatingChange", b =>
                {
                    b.HasOne("dsstats.db8.Ratings.PlayerNgRating", "PlayerNgRating")
                        .WithMany()
                        .HasForeignKey("PlayerNgRatingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PlayerNgRating");
                });

            modelBuilder.Entity("dsstats.db8.Ratings.ReplayNgRating", b =>
                {
                    b.HasOne("dsstats.db8.Replay", "Replay")
                        .WithMany("ReplayNgRatings")
                        .HasForeignKey("ReplayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("dsstats.db8.Ratings.ReplayPlayerNgRating", b =>
                {
                    b.HasOne("dsstats.db8.ReplayPlayer", "ReplayPlayer")
                        .WithMany("ReplayPlayerNgRatings")
                        .HasForeignKey("ReplayPlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("dsstats.db8.Replay", b =>
                {
                    b.Navigation("ArcadeReplays");

                    b.Navigation("ComboReplayRating");

                    b.Navigation("ReplayNgRatings");
            ...
            modelBuilder.Entity("dsstats.db8.ReplayPlayer", b =>
                {
                    ...
                    b.Navigation("ReplayPlayerNgRatings");
