        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeakRating = table.Column<double>(type: "double", nullable: false),
                    RecentRatingGain = table.Column<double>(type: "double", nullable: false),
                    MainCmdr = table.Column<int>(type: "int", nullable: false),
                    MainPercentage = table.Column<double>(type: "double", nullable: false),
