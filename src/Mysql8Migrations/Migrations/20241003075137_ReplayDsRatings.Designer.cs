...
namespace Mysql8Migrations.Migrations
{
    ...
    [Migration("20241003075137_ReplayDsRatings")]
    partial class ReplayDsRatings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dsstats.db8.Ratings.PlayerDsRating", b =>
                {
                    b.Property<int>("PlayerDsRatingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("PlayerDsRatingId"));
                    ...
                    b.HasKey("PlayerDsRatingId");

                    b.HasIndex("PlayerId", "RatingType")
                        .IsUnique();

                    b.ToTable("PlayerDsRatings");
                });

            modelBuilder.Entity("dsstats.db8.Ratings.ReplayDsRating", b =>
                {
                    b.Property<int>("ReplayDsRatingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ReplayDsRatingId"));
                    ...
                    b.HasKey("ReplayDsRatingId");

                    b.HasIndex("ReplayId");

                    b.ToTable("ReplayDsRatings");
                });

            modelBuilder.Entity("dsstats.db8.Ratings.ReplayPlayerDsRating", b =>
                {
                    b.Property<int>("ReplayPlayerDsRatingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ReplayPlayerDsRatingId"));

                    b.Property<int>("CmdrGames")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ReplayPlayerDsRatingId");

                    b.HasIndex("ReplayPlayerId");

                    b.ToTable("ReplayPlayerDsRatings");
                });
