...
public class DsstatsRatings(ReplayContext context, IOptions<DbImportOptions> importOptions) : DsRatingCalculator
{
    ...
    {
        // await RatingsStore.StorePlayerDsRatings(request, context);
        await RatingsStore.StorePlayerDsRatingsCsv(request, context, importOptions.Value.ImportConnectionString);
    }
